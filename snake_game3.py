...
class Snake:
    ...
    def move(self) -> None:        #####So far, move with WASD

        self.key_last = self.__key_current
    ...
    def eat_apple(self) -> None:
        ...
        if self.__x[0] == self.__apple.x and self.__y[0] == self.__apple.y:
            ...
            x = self.__x[len(self.__x) -1]   #snake will grow
    ...
    def gameover(self) -> bool:
        ...
        if self.__x[0] < 1 or self.__x[0] >= App.BOARD_WIDTH -1 or self.__y[0] < 1 or self.__y[0] >= App.BOARD_HEIGHT - 1:
            return True ## snake ran out of bounds
...
class App(Tk):
    ...
    TILE_SIZE = 10
        ...
        #NORMAL COLORS
    COLOR_BACKGROUND = "#283030"
    COLOR_SNAKE_HEAD = "#550885"
    COLOR_SNAKE_BODY = "#E6E6FA"
    COLOR_APPLE = "#FF0000"


        #POISON COLORS
    COLOR_POISONED_SNAKE_HEAD = "#cc2978"
    COLOR_POISONED_SNAKE_BODY = "#db7209"
    COLOR_POISON_APPLE = "#11ff00"
    ...
    def __gameloop(self):
        ...
        else: #gameover kmessage
            x = App.BOARD_WIDTH * App.TILE_SIZE / 2 ## x corrdinate of screen center
            y = App.BOARD_HEIGHT * App.TILE_SIZE / 2 # y coordinate of screen center

        self.__canvas.create_text(x, y - App.FONT_DISTANCE, fill=App.COLOR_FONT, font=App.FONT, text=App.TEXT_GAMEOVER)
        self.__canvas.create_text(x, y + App.FONT_DISTANCE, fill=App.COLOR_FONT, font=App.FONT, text= App.TEXT_POINTS + str(self.__snake.points))
